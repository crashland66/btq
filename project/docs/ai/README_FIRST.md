...
- The operational vault stores operational state and records only.
...
- Do not create or update AI/bootstrap/config documents inside the operational vault.
...
4. Never invent vault paths for people records.
