...
from queue_spec import (
    ...
    JOB_SET_CONTACT, JOB_SET_EMPLOYEE_ID, JOB_SET_ENTITY_STATUS, JOB_SET_SITE_HOURS, JOB_SET_SITE_URL, JOB_TRIGGER_RECRUITING, JOB_UPDATE_SITE_EQUIPMENT, JOB_VISIT_CREATE,
    JOB_VOICE_MEMO_NOTE,
)
