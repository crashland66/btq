...
from queue_spec import (
    ...
    JOB_SET_EMPLOYEE_ID, JOB_SET_ENTITY_STATUS, JOB_SET_SITE_HOURS, JOB_SET_SITE_URL, JOB_TRIGGER_RECRUITING, JOB_UPDATE_SITE_EQUIPMENT, JOB_VISIT_CREATE,
    JOB_VOICE_MEMO_NOTE,
)
from queue_processor.handlers import deep_analysis, employee_updates, misc, people, site_flags_notes, site_hours, site_urls, supplies_equipment, supplies_equipment_transitions, unknowns, visits
